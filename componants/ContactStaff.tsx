...
const ContactStaff: React.FC<ContactStaffProps> = ({ currentUser, addStaffMessage, isSandboxMode }) => {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="mt-1 w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-pink-500 disabled:bg-gray-100"
              ...
              <div className="text-right">
                <Button type="submit" disabled={isSandboxMode}>Send Message</Button>
              </div>
            </form>
          )}
        </Card>
