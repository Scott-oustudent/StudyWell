...
import { User, UserRole, StaffMessage, AuditLogEntry, AuditActionType, NotificationType, KnowledgeBaseArticle, WellnessVideo, MeditationTrack, WellnessArticle } from '../types';
...
type StaffTab = 'review' | 'inbox' | 'audit' | 'usermanagement' | 'knowledgebase' | 'payments' | 'wellnesscontent';

const StaffPanel: React.FC<StaffPanelProps> = (props) => {
    const { currentUser, users, setUsers, staffMessages, setStaffMessages, auditLog, knowledgeBaseArticles, manageKbArticle, handleSendReply, isSandboxMode, wellness, setWellness } = props;
