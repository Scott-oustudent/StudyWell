...
const StudentProfile: React.FC<StudentProfileProps> = ({ currentUser, setUsers, isSandboxMode }) => {
            ...
            <Card className="p-8 max-w-4xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="md:col-span-1 flex flex-col items-center text-center">
                        ...
                        <Button onClick={() => setIsEditModalOpen(true)} className="mt-6 w-full" disabled={isSandboxMode}>
