...
const FlashcardGenerator: React.FC<FlashcardGeneratorProps> = ({ currentUser, navigateTo }) => {
  ...
  const { usage, isLimitReached, incrementUsage } = useUsageTracker('flashcards', DAILY_LIMIT);
  ...
  }, [topic, isFreeTier, isLimitReached, incrementUsage]);
  ...
  return (
    <div className="p-8">
      ...
      <div className="flex items-start gap-4 mb-6">
        ...
        />
        <Button onClick={handleGenerate} disabled={isLoading || !topic || (isFreeTier && isLimitReached)}>
